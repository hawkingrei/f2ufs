...
use crate::util::crypto::{HashKey, HASHKEY_SIZE};
use crate::volume::{AllocatorRef, Arm, ArmAccess, Armor, Seq, VolumeRef, VolumeWalArmor};
...
impl Wal {
    ...
    #[inline]
    pub fn add_entry(&mut self, id: &Eid, action: Action, ent_type: EntityType, arm: Arm) {
        self.entries.insert(
            id.clone(),
            Entry {
                id: id.clone(),
