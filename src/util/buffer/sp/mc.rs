...
///
/// ```
/// use f2ufs::util::buffer::spmc::bounded::{Queue, Receiver, TryRecv};
/// use std::thread;
///
...
pub mod bounded {
    ...
    impl<T> Queue<T> {
        ...
        ///
        /// ```
        /// use f2ufs::util::buffer::spmc::bounded::{Queue, Receiver};
        ///
...
///
/// ```
/// use f2ufs::util::buffer::spmc::unbounded::{Queue, Receiver, TryRecv};
/// use std::thread;
///
...
pub mod unbounded {
    ...
    impl<T> Queue<T> {
        ...
        ///
        /// ```
        /// use f2ufs::util::buffer::spmc::unbounded::{Queue, Receiver};
        ///
        /// let c = Queue::<u32>::new();
        /// ```
        pub fn new() -> Self {
