...
impl<T> CircBuf<T> {
    ...
    ///
    /// ```
    /// use f2ufs::util::buffer::sp::internal::CircBuf;
    ///
    ...
    ///
    /// ```
    /// use f2ufs::util::buffer::sp::internal::{CircBuf, TryRecv};
    ///
    /// let cb = CircBuf::new(16);
    /// cb.send(1).unwrap();
    /// cb.send(2).unwrap();
...
impl<T> DynamicCircBuf<T> {
    ...
    ///
    /// ```
    /// use f2ufs::util::buffer::sp::internal::DynamicCircBuf;
    ///
    ...
    ///
    /// ```
    /// use f2ufs::util::buffer::sp::internal::{DynamicCircBuf, TryRecv};
    ///
    /// let cb = DynamicCircBuf::new();
    /// cb.send(1);
    /// cb.send(2);
